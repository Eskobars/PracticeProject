...
A practice project integrating Vite (Vue 3) and an ASP.NET Core backend. It pulls data from two external sources (Soccer API and JSONPlaceholder) and serves them through a REST API.
